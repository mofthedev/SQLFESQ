...
// For debugging, you can use process_query method to check if you wrote the query correctly or not.
...
$db->fetch_type = MYSQLI_ASSOC; // This is actually the default value. You can change this to MYSQLI_NUM, if you want.
print_r( $db->process_query( "SELECT * FROM table1 WHERE",["id="=>3] ) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query( "INSERT INTO table1 (col1, col2, col3) VALUES",["val1", "val2", "val3"] ) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query( "INSERT INTO table1 (col1, col2, col3) VALUES", ...$multiarr ) );
echo "\n<br>\n";
/*
[query] => INSERT INTO table1 (col1, col2, col3) VALUES (?, ?, ?),(?, ?, ?);
[values] => Array
...
print_r( $db->process_query( "UPDATE table1 SET",["name ="=>"mof", "lastname ="=>"selvi"], "WHERE", ["AND"=>["id ="=>3, "mail ="=>"mail@example.com"]] ) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query( "UPDATE table1 SET",["name ="=>"mof", "lastname ="=>"selvi"], "WHERE", ["AND"=>[["score >"=>3], ["score >"=>5]]] ) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query("UPDATE table1 SET score=score+",[15],"WHERE",["score >" => "12.2"]) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query("UPDATE table1 SET name=CONCAT(name,",[" addition"],") WHERE",["score >" => "12.2"]) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query("SELECT * FROM users WHERE", ["AND" => [ ["name LIKE"=>"%mu%"], ["name LIKE"=>"%se%"] ] ] )  );
echo "\n<br>\n";
/*
...
print_r( $db->process_query( "DELETE FROM table1 WHERE", ["AND"=>["id ="=>3, "activetime <"=>"12312313"]] ) );
echo "\n<br>\n";
/*
...
print_r( $db->process_query( "SELECT * FROM table1 as t1 INNER JOIN table2 as t2 ON t1.id=t2.id WHERE t1.name!=t2.name AND (",["OR"=>["t1.score >"=>30, "t2.score <"=>20]],")" ) );
echo "\n<br>\n";
/*
